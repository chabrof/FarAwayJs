...
function _createWrappingObjects(objDescriptions) {
    let wrappingObjects = {};
    objDescriptions.forEach((objDescription) => {
...
_wrappingObjFactory['instantiable'] = function (objDescription) {
    ...
    func.__farAwayInstIdx__ = undefined;
...
function farCall(name, args = [], instanceIdx = undefined) {
...
function farInstantiate(name, instance, args = []) {
